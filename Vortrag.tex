...
% 			\frametitle{Table of Contents}
	...
	\hline
	 ...
	 use cases & \parbox[t]{4cm}{semantic mirror for Wikipedia; categorization;
	 ``nucleus of the semantic web''} & \parbox[t]{4cm}{build own schema} \\
	   $+$ & \parbox[t]{4cm}{has many outgoing
	 links;
	 good categorization} & \parbox[t]{4cm}{many sources; possibly more
	 information}\\
	 $-$ & limited information & \parbox[t]{4cm}{might seem a bit unstructured at
