...
% 			\frametitle{Table of Contents}
	...
	\hline
	 & WordNet & YAGO\\
	 Sources & manual & Wikipedia, GeoNames, WordNet, Universal WordNet\\
	 $+$ & \parbox[t]{4cm}{good for word sense\\ disambiguation\\ really big} & 
	 \parbox[t]{5cm}{additional spatial and temporal information\\ many sources\\very precise}\\
	 $-$ & \parbox[t]{5cm}{too fine-grained\\ no domain-specific vocabulary} & \parbox[t]{5cm}{not that up-to-date \\ no good SPARQL endpoint} \\
	\hline
	\end{tabular}
	\end{table}
	\end{frame}
